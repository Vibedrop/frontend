import { Avatar, Box, Card, Flex, Slider, Text } from '@radix-ui/themes'
import { ArrowRightToLine, Play, Repeat, RotateCcw, SkipBack, SkipForward, Volume2 } from 'lucide-react'
