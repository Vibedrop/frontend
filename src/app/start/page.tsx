  ...
  return (
    <>
      ...
      <Flex
        ...
        style={{
          backgroundImage: 'linear-gradient(180deg, rgba(87, 83, 198, 0.672) 0%, rgba(184, 186, 248, 0.672) 100%)',
        }}>
        ...
        <Flex className="w-full flex-col lg:flex-row items-center max-w-screen-lg gap-md lg:gap-xxl text-center lg:text-left pb-sm 2xl:pb-xl">
          <Flex className="flex-1 flex-col items-center">
            <Flex className="flex-col max-w-[290px] gap-md 2xl:ml-xl">
              ...
              <Text className="text-body-s">Upload your track, keep multiple versions and invite collaborators.</Text>
            </Flex>
          </Flex>
        ...
        <Flex className="w-full flex-col lg:flex-row items-center max-w-screen-lg gap-md lg:gap-xxl text-center lg:text-left pb-sm 2xl:pb-xl">
          ...
          <Flex className="flex-1 flex-col items-center">
            <Flex className="flex-col max-w-[290px] gap-md 2xl:mr-xl">
              ...
              <Text className="text-body-s">Time-stamped, version-specific comments.</Text>
            </Flex>
          </Flex>
        </Flex>
        ...
        <Flex className="w-full flex-col lg:flex-row items-center max-w-screen-lg gap-md lg:gap-xxl text-center lg:text-left pb-sm 2xl:pb-xl">
          <Flex className="flex-1 flex-col items-center">
            <Flex className="flex-col max-w-[290px] gap-md 2xl:ml-xl">
              ...
              <Text className="text-body-s">Keep track of version in all your projects, all in one place.</Text>
            </Flex>
          </Flex>
        ...
        <Flex className="w-full flex-col lg:flex-row items-center max-w-screen-lg gap-md lg:gap-xxl text-center lg:text-left pb-sm 2xl:pb-xl">
          ...
          <Flex className="flex-1 flex-col items-center">
            <Flex className="flex-col max-w-[290px] gap-md 2xl:mr-xl">
              <Text className="text-body-l">Keep control of your sound</Text>
              <Text className="text-body-s">Only invited collaborators has access. No leaks. No surprises. Just safe, focused creation.</Text>
            </Flex>
          </Flex>
        </Flex>
      </Flex>
